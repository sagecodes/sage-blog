...
I decided to split up the 100 days into 4 phases. Roughly 25 days each.

- phase 1: Quick implementations and accelerated learning
- phase 2: Specialization (Computer Vision)
- phase 3: Round out knowledge, Deploy Models & start project planning
...
#### Phase 2: Focus on Computer Vision 

1. 

#### Phase 3: Round out knowledge, Deploy Models & start project planning

#### Phase 4: Build & deploy capstone Projects
